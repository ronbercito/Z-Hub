...
export const CHANGELOG = [
  ...
  { type: "Corrección", text: "Se corrige el cierre JSX faltante del campo Recordatorio #3 en la configuración de Facturación del cliente, que impedía compilar el frontend." },
];
