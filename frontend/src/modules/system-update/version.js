 ...
 */
export const PANEL_VERSION = "1.1.101";
export const CHANGELOG = [
  { type: "Colas simples", text: "La columna Comentario ahora aparece primero." },
  { type: "Compatibilidad", text: "No cambian datos ni operaciones del MikroTik." },
];
