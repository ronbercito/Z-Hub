 ...
 * Actualización: 2026-09-08 — la ubicación del listado abre un minimapa con navegación y datos guardados.
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl shadow-xl overflow-hidden">
        <div className="overflow-x-auto"><table className="w-full text-left text-xs">
          <thead className="bg-slate-950 text-slate-400 uppercase font-semibold border-b border-slate-800"><tr>
            <th className="py-3 px-4">Abonado / Contacto</th><th className="py-3 px-4">Plan / Tarifa</th><th className="py-3 px-4">IP / Conexión</th><th className="py-3 px-4">Caja NAP / Potencia</th><th className="py-3 px-4">Estado / Deuda</th><th className="py-3 px-4 text-center">Acciones</th>
          </tr></thead>
