...
export default function Sidebar({ activeTab, setActiveTab, isOpen, setIsOpen, companyName="Z-Hub", logoData="" }) {
  ...
  const itemClass=active=>`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs ${active?"font-bold":"font-semibold"} transition-all duration-150 group ${active?"bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-sm":"text-slate-400 hover:text-slate-200 hover:bg-slate-800/60"}`;
