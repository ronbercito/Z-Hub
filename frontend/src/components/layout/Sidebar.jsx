 ...
 * Actualización: 2026-09-09 — barra de desplazamiento visible para submenús largos.
 * Función: navegación lateral principal y submenús del panel.
 * Regla: solo se modifica el comportamiento visual del área de navegación; rutas, permisos y lógica permanecen intactos.
 */
