...
- Versión funcional actual: **1.1.11**, correspondiente al refinamiento visual del template Z-Hub Blanco para reducir brillo e iluminación, manteniendo intacta la lógica funcional 1.1.10.
